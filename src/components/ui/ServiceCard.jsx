...
export default function ServiceCard({ icon, title, description, linkTo = '/services', variant = 'dark' }) {
  const isDark = variant === 'dark'

  const card = (
    <div
      className={`group rounded-lg p-6 border transition-all duration-200 h-full flex flex-col gap-3 ${
        isDark
